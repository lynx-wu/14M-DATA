...
class CustomResNeXt(nn.Module):
    def __init__(self, dropout_rate=0.5):
        ...
        self.resnext = models.resnext50_32x4d(weights=models.ResNeXt50_32X4D_Weights.IMAGENET1K_V1)
        self.resnext.fc = nn.Sequential(
            nn.Dropout(dropout_rate),
            nn.Linear(self.resnext.fc.in_features, 2)  # 输出类别数为2
        )
...
if __name__ == '__main__':
    ...
    model = CustomResNeXt(dropout_rate=0.5).to(device)
    print('test')
