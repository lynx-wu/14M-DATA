...
class CustomDataset(Dataset):
    def __init__(self, root_dir, transform=None, split='train', sample_size=800000):
...
def train_val_data_process():
    ...
    train_dataset = CustomDataset(root_dir=root_dir, transform=transform, split='train', sample_size=800000)
    train_loader = DataLoader(train_dataset, batch_size=64, shuffle=True, pin_memory=True)

    val_dataset = CustomDataset(root_dir=root_dir, transform=transform, split='val', sample_size=200000)
...
if __name__ == '__main__':
    ...
    print('test1')
    train_val_model_process(model, train_loader, val_loader, 3)
    print('test2')