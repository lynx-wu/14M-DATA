...
train_dir = '/media/disk/01drive/07qiulin/pj1/datasets/dr/augmented_resized_V2/train'
val_dir = '/media/disk/01drive/07qiulin/pj1/datasets/dr/augmented_resized_V2/val'
...
def train_val_model_process(model, train_loader, val_loader, num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        if epoch >= 4:
            ...
            plt.subplot(2, 2, 1)
            plt.plot(range(1, epoch + 2), train_accuracies, label='Val Accuracy')
            plt.plot(range(1, epoch + 2), val_accuracies, label='Train Accuracy')
            plt.xlabel('Epoch')
            plt.ylabel('Accuracy')
